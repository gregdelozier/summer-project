...
//const { players } = require("./gameEngine");
...
function setup() {
    ...
    // p1Img = loadImage("https://webdev-stark.cs.kent.edu/~jsipahio/game/player-1.png");
    // p2Img = loadImage("https://webdev-stark.cs.kent.edu/~jsipahio/game/player-2.png");
...
function drawPlayer1(pos){
    fill(players[0].color.red, players[0].color.green, players[0].color.blue);
    rect(pos.xpos, pos.ypos, 25);
}

function drawPlayer2(pos){
    fill(players[1].color.red, players[1].color.green, players[1].color.blue);
    rect(pos.xpos, pos.ypos, 25);
}
